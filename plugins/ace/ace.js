...
var RevealAce = window.RevealAce || (function() {
	...
	function mkEditor(iframe) {
		...
		// [2018.01.21] Updated to local from npm installed ace-builds by @SteveHartzog
		// [2018.01.24] Added extensions by @SteveHartzog
		d.write("<!DOCTYPE html><html>"+
		"<head>"+
		"<script src='/node_modules/ace-builds/src-min/ace.js' type='text/javascript' charset='utf-8'></script>\
		<script src='/node_modules/ace-builds/src-min/ext-emmet.js' type='text/javascript' charset='utf-8'></script>\
		<script src='/node_modules/ace-builds/src-min/ext-keybinding_menu.js' type='text/javascript' charset='utf-8'></script>\
		<script src='/node_modules/ace-builds/src-min/ext-settings_menu.js' type='text/javascript' charset='utf-8'></script>\
		<script src='/node_modules/ace-builds/src-min/ext-themelist.js' type='text/javascript' charset='utf-8'></script>\
		<script src='/node_modules/ace-builds/src-min/ext-whitespace.js' type='text/javascript' charset='utf-8'></script>")
		if (mode) {
			d.write("<script src='/node_modules/ace-builds/src-min/mode-" + mode + ".js' type='text/javascript' charset='utf-8'></script>");
		}
		d.write("</head>"+
			"<body>"+
